const M = {
  ...
  "Adicicionales": {
    ...
    p: [
      ...
      ["Arroz blanco", 10, "", "images/adicionales/arroz-blanco.jpg"],
      ["Porción de Maduro", 10, "", "images/adicionales/porcion-de-maduro.jpg"],
...
let current = null;
let cart = JSON.parse(localStorage.getItem("puraSelvaCart") || "[]");
...
function sendWhatsApp(number) {
  ...
  if (!cart.length) {
    return alert("Tu pedido está vacío.");
  }
...
$("#sendOrder").onclick = () =>
  sendWhatsApp(WHATSAPP1);

$("#sendOrder2").onclick = () =>
  sendWhatsApp(WHATSAPP2);
